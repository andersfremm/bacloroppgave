...
## status_gui.tcl has been generated with ProgBit autoreg tools by user User
################################################################################
...
namespace eval status_gui {
   ...
   variable regList {-name AEmpty -gloc {0 1} -gtype label} {-name BEmpty -gloc {0 2} -gtype label} {-name Version -gloc {0 0} -gtype label} {-name ExtError -gloc {0 5} -gtype label} {-name ExtStatus -gloc {0 6} -gtype label} {-name AWrOnFull -gloc {0 3} -gtype label} {-name BRdOnEmpty -gloc {0 4} -gtype label}
   variable vUpdate 0
   variable AEmpty
   variable BEmpty
   variable Version
