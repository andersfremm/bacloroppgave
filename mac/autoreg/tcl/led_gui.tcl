...
## led_gui.tcl has been generated with ProgBit autoreg tools by user User
################################################################################
...
namespace eval led_gui {
   ...
   variable regList {-name led3 -gloc {0 3} -gtype checkbutton} {-name led2 -gloc {0 2} -gtype checkbutton} {-name led1 -gloc {0 1} -gtype checkbutton} {-name led0 -gloc {0 0} -gtype checkbutton}
   variable vUpdate 0
   variable led3
   variable led2
   variable led1
