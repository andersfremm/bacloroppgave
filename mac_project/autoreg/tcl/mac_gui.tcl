...
namespace eval mac_gui {
   variable guiList -name mac -path /i0jtag/i0demo/i0core/i0count/i0rb_mac -gspan {6 8} -gw {12 8} -gupdate {4 7}
   variable regList {-name setcnt -gloc {0 4} -gtype entry} {-name max -gloc {0 1} -gtype entry} {-name up -gloc {2 0} -gtype checkbutton} {-name preset -gloc {2 4} -gtype button} {-name down -gloc {2 1} -gtype checkbutton} {-name stepdown -gloc {2 3} -gtype button} {-name stepup -gloc {2 2} -gtype button} {-name readcnt -gloc {4 0} -gtype label} {-name revision -gloc {0 7} -gtype label} {-name prescale -gloc {0 0} -gtype entry}
   variable vUpdate 0
   variable setcnt
   variable max
   variable up
...
proc mac_gui::getreg { } {
   ...
   set errorInfo ""
   if {[catch {
      set mac_gui::setcnt [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/setcnt]
      set mac_gui::max [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/max]
      set mac_gui::up [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/up]
      set mac_gui::down [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/down]
      set mac_gui::readcnt [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/readcnt]
      set mac_gui::revision [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/revision]
      set mac_gui::prescale [aget /i0jtag/i0demo/i0core/i0count/i0rb_mac/prescale]
   } cmdres] == 1} {
      set code 1
      set returnValue NOK
...
proc mac_gui::main { } {
   ...
   ttk::labelframe $w.lf -text /i0jtag/i0demo/i0core/i0count/i0rb_mac
   ...
   bind $w.lf.wsetcntVal <Return> {
      catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/setcnt [%W get]}
   }
   ...
   bind $w.lf.wmaxVal <Return> {
      catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/max [%W get]}
   }
   label $w.lf.wup -text up -width 12
   grid  $w.lf.wup -column 2 -row 0 -sticky ew
   checkbutton $w.lf.wupVal -variable mac_gui::up -width 8 -justify center -command {catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/up $mac_gui::up}}
   grid  $w.lf.wupVal -column 3 -row 0 -sticky ew
   button $w.lf.wpresetVal -text preset -background lightblue -width 8 -justify center -command {catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/preset 1}}
   grid  $w.lf.wpresetVal -column 2 -row 4 -sticky ew
   label $w.lf.wdown -text down -width 12
   grid  $w.lf.wdown -column 2 -row 1 -sticky ew
   checkbutton $w.lf.wdownVal -variable mac_gui::down -width 8 -justify center -command {catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/down $mac_gui::down}}
   grid  $w.lf.wdownVal -column 3 -row 1 -sticky ew
   button $w.lf.wstepdownVal -text stepdown -background lightblue -width 8 -justify center -command {catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/stepdown 1}}
   grid  $w.lf.wstepdownVal -column 2 -row 3 -sticky ew
   button $w.lf.wstepupVal -text stepup -background lightblue -width 8 -justify center -command {catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/stepup 1}}
   ...
   bind $w.lf.wprescaleVal <Return> {
      catch {aset /i0jtag/i0demo/i0core/i0count/i0rb_mac/prescale [%W get]}
   }
