...
## revision_gui.tcl has been generated with ProgBit autoreg tools by user User
################################################################################
...
namespace eval revision_gui {
   ...
   variable regList {-name month -gloc {0 3} -gtype label} {-name year -gloc {0 2} -gtype label} {-name rctest -gloc {2 2} -gtype label} {-name hour -gloc {0 5} -gtype label} {-name day -gloc {0 4} -gtype label} {-name trunkrev -gloc {0 0} -gtype label} {-name branchesrev -gloc {0 1} -gtype label} {-name minute -gloc {0 6} -gtype label} {-name latch -gloc {2 3} -gtype button} {-name rwtest -gloc {2 0} -gtype entry} {-name rtest -gloc {2 1} -gtype label}
   variable vUpdate 0
   variable month
   variable year
   variable rctest
